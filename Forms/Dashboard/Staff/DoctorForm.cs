...
namespace HealthCare_Plus.Forms.Dashboard.Staff
{
    public partial class DoctorForm : Form
    {
        ...
        private void Search_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Пожалуйста, введите поисковый запрос", "Пустой поиск", default, MessageBoxIcon.Error);
                return;
            }
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Врач не найден", "Нету", default, MessageBoxIcon.Information);
                    return;
                }
