...
namespace HealthCare_Plus.Forms.Dashboard.Admin
{
    public partial class ReportsForm : Form
    {
        ...
        private void DoctorsReportBtn_Click_1(object sender, EventArgs e)
        {
            GenerateReport(
                selectDocQuery,
                "DoctorsDataSet",
        ...
        private void PatientsReportBtn_Click_1(object sender, EventArgs e)
        {
            string selectPatiQuery = "SELECT * FROM Patients";
            GenerateReport(
                selectPatiQuery,
        ...
        private void PaymentsReportBtn_Click_1(object sender, EventArgs e)
        {
            string selectPaymentsQuery = "SELECT * FROM Payments";
            GenerateReport(
                selectPaymentsQuery,
