    ...
    public partial class PatientsForm : Form
    {
        ...
        private void Add_btn_Click(object sender, EventArgs e)
        {
            ...
            if (isValid)
            {
                ...
                if (sqlQueryStatus)
                {
                    MessageBox.Show("Пациент успешно добавлен", "Успех", default, MessageBoxIcon.Information);
        ...
        private void Update_btn_Click(object sender, EventArgs e)
        {
            ...
            if (isValid)
            {
                ...
                if (sqlQueryStatus)
                {
                    MessageBox.Show("Пациент успешно ОБНОВЛЕН", "Успех", default, MessageBoxIcon.Information);
                    LoadPatientData(); // REFRESH DATA GRID VIEW
                    ResetInputs();
                }
                else
        ...
        private void Delete_btn_Click(object sender, EventArgs e)
        {
            if (isPatientSelected)
            {
                ...
                if (confirmation == DialogResult.Yes)
                {
                    ...
                    if (sqlQueryStatus)
                    {
                        MessageBox.Show("Пациент успешно удален", "Успех", default, MessageBoxIcon.Information);
                        LoadPatientData(); // REFRESH DATA GRID VIEW
        ...
        private void Add_btn_Click_1(object sender, EventArgs e)
        {
            ...
            if (isValid)
            {
                ...
                if (sqlQueryStatus)
                {
                    MessageBox.Show("Пациент успешно добавлен", "Success", default, MessageBoxIcon.Information);
                    LoadPatientData(); // REFRESH DATA GRID VIEW
                    ResetInputs();
                }
                else
