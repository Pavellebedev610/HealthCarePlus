    ...
    public partial class StaffLoginForm : Form
    {
        ...
        private void guna2GradientButton1_Click(object sender, EventArgs e)
        {
            ...
            if (validation == "valid")
            {
                ...
                {
                    Console.WriteLine(ex.Message);
                    MessageBox.Show("Ошибка сервера повторите попытку позже", "Ошибка", default, MessageBoxIcon.Error);
                    return;
                }
                ...
                if (dataReader.Read())
                {
                    ...
                    if (role != "admin" && role != "staff")
                    {
                        MessageBox.Show("У вас нет доступа!", "Неавторизованны", default, MessageBoxIcon.Error);
                        return;
                    }
